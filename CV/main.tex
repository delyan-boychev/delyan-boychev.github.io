...
CS undergraduate and INSAIT research scholar working on vision-language models, remote sensing, 3D scene understanding, and efficient transformer inference. IOAI lecturer; previously a Quant ML intern at Man Group and an NLP research intern at Graphwise. Published work spans domain adaptation, synthetic-image detection, adversarial robustness, and interpretability.
...
\section{\texorpdfstring{\faGraduationCap}{} Education}
  ...
  \resumeSubheading
      {\parbox[t]{0.8\textwidth}{\href{https://insait.ai/delyan-boychev/}{INSAIT Scholar} (\href{https://explorer.insait.ai/}{highly-selective 4-year program}), \\ Faculty of Mathematics and Informatics, Sofia University}}{Sofia, Bulgaria}
...
\section{\texorpdfstring{\faFolderOpen}{} Projects}
    \resumeSubHeadingListStart
      ...
      \resumeItemListStart
        \resumeItem{Fuses QK, relative-position lookup, online softmax, and PV for DeBERTa-v2/v3 into a streaming Triton kernel that avoids materializing the full attention matrix.}
